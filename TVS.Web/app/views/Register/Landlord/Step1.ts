class signUpLandlordStep1Ctrl {
    ...
    public savePerson () {
            this.http.post(serviceBase + '/Api/Landlord/Save', this.newPerson)
                .success(response=> {
                    this.newPerson = <TVS.API.Entities.Person>response;
                    this.location.path('/lsignup2');
                })
...
app.controller('signUpLandlordStep1Ctrl', signUpLandlordStep1Ctrl);
