        ...
        protected override void Seed(TVS.API.AppDbContext context)
        {
            ...
            if (!context.Roles.Any())
            {
                ...
                context.RoleParameters.AddOrUpdate(new[]
                {
                    ...
                    {
                        RoleId = tenant.Id,
                        ParameterName = "Property Care",
                        Description = "Property Care"
                    },
                    new RoleParameter
                    {
                        RoleId = tenant.Id,
                        ParameterName = "Attitude with neigbours",
                        Description = "Attitude with neigbours"
                    },
                    ...
                    {
                        RoleId = landLord.Id,
                        ParameterName = "Parking Space",
                        Description = "Parking Space"
                    },
                    new RoleParameter
                    {
                        RoleId = landLord.Id,
                        ParameterName = "Landlord behaviour",
                        Description = "Landlord behaviour"
                    },
                    new RoleParameter
                    {
                        RoleId = landLord.Id,
                        ParameterName = "Overall value for money",
